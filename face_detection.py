...
file_path = "run/detect/train7/weights/best.pt"  # Ensure this path is correct
            ...
            for result in results:
                for box in result.boxes.data.tolist():  # Loop through detected boxes
                    ...
                    if model.names[cls] == "drowsy":
                        ...
                        elif time.time() - drowsy_start_time >= 3:  # Check if 5 seconds have passed
                            if not alert_triggered:
                                print("Alert: User has been drowsy for 3 seconds!")
